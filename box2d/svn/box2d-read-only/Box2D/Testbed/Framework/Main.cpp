...
static void Keyboard(unsigned char key, int x, int y)
{
	...
	case '[':
		...
		//gw--testSelection;
		//gwif (testSelection < 0)
		//gw{
		//gw	testSelection = testCount - 1;
		//gw}
		glui->sync_live();
		break;
...
{
	//gwdelete test;
	//gwentry = g_testEntries + testIndex;
	//gwtest = entry->createFcn();
    Resize(width, height);
}
