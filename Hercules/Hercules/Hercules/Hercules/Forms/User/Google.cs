...
namespace MME.Hercules.Forms.User
{
    public partial class Google : Form
    {
        ...
        public Google(Session currentSession)
        {
 ...
 */
            ...
            if (ischeckin)
            {
                 ...
                 * */
                Uri uri =
                    new Uri("http://accounts.google.com/o/oauth2/auth?" +
                        "response_type=code&" +
                        "client_id=64819313472.apps.googleusercontent.com&" +
        ...
        private void webBrowser1_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            ...
            if (pos <= 0) // a page other than access token...
            {
                ...
                foreach (HtmlElement el in inputs)
                {
                     ...
                     * */
                    if (el.Name == "submit_approve_access")
                    {
                        el.InvokeMember("click");
                        bFakeClicked = true;
        ...
        private void Google_KeyDown(object sender, KeyEventArgs e)
        {

        }

        private void Google_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((int)e.KeyChar == 27)
            {
                Application.Exit();
