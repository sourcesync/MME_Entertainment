...
$photopath = "./photo";
$to = $_POST["email"];
$htmlbody = "Thank you for visiting our booth today!  Please <a href='%url%'>click here</a> to view your favorite photo.";
$textbody = "Thank you for visiting our booth today!  Please visit %url% to view your favorite photo.";
